...
class m200727094709cc_task extends Migration
{
    public function up()
    {
        $sql = <<<EOF
        ...
        CREATE TABLE `cc_task` (
          ...
          `cc_task_status` enum('open','running','error','terminated','close') NOT NULL DEFAULT 'open' COMMENT '任务状态',
          `cc_task_next_run_time` datetime NOT NULL DEFAULT '1000-01-01 00:00:00' COMMENT '下次重试时间',
